...
class MealRestControllerTest extends AbstractControllerTest {
    ...
    void getAll() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(REST_URL))
                ...
                .andExpect(contentJson(getTos(MealTestData.MEALS, USER.getCaloriesPerDay())));
    }
    ...
    void getBetween() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(REST_URL + "between?start=2015-05-30T07:00&end=2015-05-31T11:00:00")
